...
from models.EEGViT_KUL import EEGViT_KUL_CL, EEGViT_KUL_pretrained_Restruct, EEGViT_KUL_pretrained_wav2vec_frequency_sum_768_05s_new, EEGViT_KUL_pretrained_wav2vec_frequency_sum_768
from dataset.EEGEyeNet import EEGEyeNetDataset
from dataset.KUL import data_read_CL_feature
...
class Projection_768_low(nn.Module):
    def __init__(self, in_size=768, out_size=64):
        super().__init__()
    ...
    def forward(self, x):
        # b, band, _= x.shape
        # x = torch.reshape(x, (int(b*2), band, 768))
        # x = x + self.classfy(x)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--eeg_data', type=str, default='/media/c1/CYB/EEGViT/eeg_data/preprocessed_data_50hz_mean/', help='name of features')
    parser.add_argument('--stimulus_data', type=str, default='/media/c1/CYB/EEGViT/stimulus', help='name of features')
    ...
    parser.add_argument('--window_length', type=float, default=1, help='window length of EEG')
    ...
    parser.add_argument('--result_path', type=str, default='right_sum_optim_mlp_KUL_result_wavlm_frequency_24layer_1s_chosen_new_nowarm.txt', help='result path')
    ...
    for i in range(1, 19):
        ...
        for k in range(args.fold):
            ...
            data, label, stimulus = data_read_CL_feature(nSub, args.feature_name, args.window_length, args.overlap, args.condition, args.eeg_data, args.stimulus_data)
